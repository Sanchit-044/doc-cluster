...
// //       }});
// //     const data = `
// //     <body style="margin: 0; padding: 0; width: 100%; font-family: Arial, sans-serif; background-color: #f0f7ff;">
//       <div style="max-width: 600px; width: 100%; margin: 20px auto; padding: 20px; border: 1px solid #e6f0fb; border-radius: 10px; background-color: #ffffff; box-sizing: border-box;">
        
//         <div style="text-align: center; margin-bottom: 30px;">
//           <img src="https://i.ibb.co/T1BNfgR/Untitled.jpg" alt="Doc-Cluster" style="width: 140px; max-width: 100%;">
//         </div>

//         <p style="color: #0f172a; font-size: 18px; line-height: 1.5; text-align: center; margin: 0 20px;">
//           Hello ${username},
//         </p>

//         <p style="color: #475569; font-size: 16px; line-height: 1.6; text-align: center; margin: 20px 20px;">
//           We received a request to reset your password. Click the button below to proceed:
//         </p>

//         <div style="text-align: center; margin: 30px 0;">
//           <a href="${resetUrl}" style="background-color: #2563eb; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-size: 16px; display: inline-block;">
//             Reset Password
//           </a>
//         </div>
...
//         <hr style="border: none; border-top: 1px solid #e6f0fb; margin: 30px 0;">

//         <p style="font-size: 13px; color: #94a3b8; text-align: center; margin: 20px;">
//           If you're having trouble clicking the button, copy and paste the URL below into your web browser:
//         </p>

//         <p style="font-size: 13px; color: #2563eb; word-break: break-all; text-align: center; margin: 0;">
